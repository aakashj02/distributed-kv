...
const file_proto_kv_proto_rawDesc = "" +
	...
	"\x05found\x18\x02 \x01(\bR\x05found2_\n" +
	"\rKeyValueStore\x12&\n" +
	"\x03Put\x12\x0e.kv.PutRequest\x1a\x0f.kv.PutResponse\x12&\n" +
	"\x03Get\x12\x0e.kv.GetRequest\x1a\x0f.kv.GetResponseB.Z,github.com/aakashj02/distributed-kv/proto;kvb\x06proto3"
...
var file_proto_kv_proto_depIdxs = []int32{
	...
	1, // 2: kv.KeyValueStore.Put:output_type -> kv.PutResponse
	3, // 3: kv.KeyValueStore.Get:output_type -> kv.GetResponse
